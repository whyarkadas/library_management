...
describe('BookController', () => {
    ...
    describe('POST /books/:id/borrow', () => {
        it('should allow borrowing an available book', async () => {
    ...
    describe('POST /books/:id/return', () => {
        it('should allow returning a borrowed book with rating', async () => {
            const userRepo = LibraryDataSource.getRepository(User);
            const bookRepo = LibraryDataSource.getRepository(Book);
        ...
        it('should return 404 when borrowed book record not found', async () => {
            const bookRepo = LibraryDataSource.getRepository(Book);
            const book = await bookRepo.save({ 
                title: 'Test Book',
                averageRating: 0,
